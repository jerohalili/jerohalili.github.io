...
const PORTFOLIO_DATA = {
  ...
  skillNodes: [
    ...
    { label: "AI Automation", x: 0.3, y: 0.35, size: 14, group: "ai" },
    { label: "LLM Integration", x: 0.18, y: 0.45, size: 12, group: "ai" },
    { label: "n8n", x: 0.2, y: 0.65, size: 11, group: "ai" },
    { label: "Prompt Eng.", x: 0.35, y: 0.88, size: 10, group: "ai" },
    { label: "UI/UX Design", x: 0.5, y: 0.88, size: 11, group: "design" },
    { label: "Marketing Tech", x: 0.68, y: 0.15, size: 10, group: "design" },
    { label: "JavaScript", x: 0.18, y: 0.22, size: 12, group: "tools" },
    { label: "Python", x: 0.82, y: 0.25, size: 10, group: "tools" },
    { label: "Git & GitHub", x: 0.17, y: 0.75, size: 11, group: "tools" },
